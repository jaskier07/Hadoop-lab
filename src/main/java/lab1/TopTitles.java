...
// <<< Don't Change
    ...
    public static class TitleCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            //List<String> cw = Arrays.asList("the", "an", "a", "and", "of", "to", "in", "am", "is", "are", "at", "not");
            String line = value.toString();
            StringTokenizer tokenizer = new StringTokenizer(line, delimiters);//" \t/.;,?!-:@[]{}()_*/");
    ...
    public static class TopTitlesReduce extends Reducer<NullWritable, TextArrayWritable, Text, IntWritable> {
        ...
        public void reduce(NullWritable key, Iterable<TextArrayWritable> values, Context context) throws IOException, InterruptedException {
            for (TextArrayWritable array : values) {
                ...
                context.write(new Text(pair[1].toString()), new IntWritable(new Integer(pair[0].toString())));
            }
        }
    }
